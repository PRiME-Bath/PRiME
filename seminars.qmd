...
### **21/10/2026** Contextualising the Curriculum through the History of Mathematics
:::{.columns}
:::{.column width=10%}
...
### **18/11/2026** Digital Accessibility in Maths: Making Things Add Up for Everyone
:::{.columns}
:::{.column width=10%}
...
### **02/12/2026** Student Community & Belonging
:::{.columns}
:::{.column width=10%}
...
<!-- :::{.columns} -->
<!-- :::{.column width=10%} -->
<!-- ![](images/Logos/Bham-Logo.png){width=100%} -->
<!-- ::: -->
<!-- :::{.column width=2%} -->
<!-- ::: -->
<!-- :::{.column width=88%} -->
<!-- **Speaker**:  [Michael Grove](https://www.birmingham.ac.uk/staff/profiles/maths/grove-michael) (University of Birmingham) -->
