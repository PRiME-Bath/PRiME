...
<!-- ### ![](images/logos/Bath-Logo.png){width=100px} 11/02/2026 - TBC, Ilaria Bussoli (University of Bath) -->

<!-- :::{.callout-note title="Asbtract" icon=false collapse=true} -->
<!-- TBC -->
<!-- ::: -->

<!-- ### ![](images/logos/Bath-Logo.png){width=100px} 18/02/2026 - TBC, Ruth Hand (University of Bath Skills Centre) -->

<!-- :::{.callout-note title="Asbtract" icon=false collapse=true} -->
<!-- TBC -->
<!-- ::: -->

<!-- ### ![](images/logos/OU-Logo.png){width=100px} 11/03/2026 - TBC, Brigitte Stenhouse (The Open University) -->

<!-- :::{.callout-note title="Speaker:  Brigitte Stenhouse" icon=false collapse=true} -->
<!-- [Brigitte Stenhouse](https://sites.google.com/view/brigitte-stenhouse/home) is a historian of mathematics who is curious about how mathematicians build communities and gatekeep knowledge. -->
<!-- ::: -->
...
### ![](images/logos/Bath-Logo.png){width=100px} 11/02/2026 - TBC, *Ilaria Bussoli*

:::{.callout-note title="Speaker:  Ilaria Bussoli" icon=false collapse=true}
...
### ![](images/logos/Bath-Logo.png){width=100px} 04/03/2026 - Re-engagement Tutorials: Piloting A Dual Tutorial Model, *Thomas Cottrell*, *Tamsin Smith*, *Ruth Wye* & *Ameen Hassan*

:::{.callout-note title="Speakers:  Thomas Cottrell, Tamsin Smith, Ruth Wye & Ameen Hassan" icon=false collapse=true}

:::

:::{.callout-note title="Abstract" icon=false collapse=true}
Over recent semesters, the Department of Mathematical Sciences has observed a consistent decline in tutorial attendance beyond the mid-semester point, suggesting that many students disengage after falling behind with course material. To address this challenge, we piloted for an alternative model for year 1algebra tutorials that ran alongside the standard model. This opportunity provided focused, slower-paced delivery with personalised revision, and confidence-building support.
...
### ![](images/logos/Edinburgh-Logo.png){width=100px} 25/03/2026 - TBC, *Paola Iannone*
...
## Previous Seminars {.unnumbered}

:::{.panel-tabset}

### Academic Year 2025/6 {.unnumbered}

#### ![](images/logos/UEA-Logo.png){width=100px} 08/10/2025 - MathTASK: Challenging Students’ Discourses About Mathematics and its Pedagogy
...
#### ![](images/logos/Cardiff-Logo.png){width=100px} 19/11/2025 - Flipping the Foundations, Robert Wilson
...
#### ![](images/logos/Bath-Logo.png){width=100px} 13/11/2024 - Statistical Models For Improving Maths Tests
...
#### ![](images/logos/Bath-Logo.png){width=100px} 20/11/2024 - HEA Fellowships in Maths
...
#### ![](images/logos/Warwick-Logo.png){width=100px} 26/02/2025 - Filling the Gap: Finding Your Niche
...
#### ![](images/logos/OU-Logo.png){width=100px} 26/03/2025 - Understanding and Promoting Meaningful Learning Experiences in Undergraduate Mathematical Education
...
#### ![](images/logos/Bath-Logo.png){width=100px} 01/11/2023 - Interactive Mathematics with VisualPDE
...
#### ![](images/logos/Bath-Logo.png){width=100px} 15/11/2023 - Generative AI in Mathematics Teaching & Learning
...
#### ![](images/logos/Cardiff-Logo.png){width=100px} 13/12/2023 - Promoting Participation With Statistics: Innovations for Teaching
...
#### ![](images/logos/Loughborough-Logo.png){width=100px} 28/02/2024 - Making Mathematics Lectures More Engaging
...
#### ![](images/logos/Bath-Logo.png){width=100px} 13/03/2024 - How to Start in the World of Mathematics Education Research
...
#### ![](images/logos/Leeds-Logo.png){width=100px} 27/03/2024 - How to Think Like a Mathematician 
...
#### ![](images/logos/Warwick-Logo.png){width=100px} 10/04/2024 - Students as Agents of Change: Partners & Researchers
