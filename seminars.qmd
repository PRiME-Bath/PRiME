All seminars are held in **Wolfson Lecture Theatre 4W 1.7** on **Wednesdays 11:15-12:00**.  All the talks will be broadcasted live on the following [Zoom Link](https://bath-ac-uk.zoom.us/j/96861106151?pwd=wmYbhw8eSHSbV3t7Z2uiI8Dhvw4jGp.1).

**Meeting ID**:  968 6110 6151
...
|:----------:|:-------:|:-----------:|:-----:|
| 21/10/2026 | [Brigitte Stenhouse](https://profiles.open.ac.uk/brigitte-stenhouse) | The Open University | [Contextualising the Curriculum through the History of Mathematics](#BS-21-10-2026) |
| 18/11/2026 | [Joshua Lim](https://www.bath.ac.uk/teams/centre-for-learning-teaching-clt/) | University of Bath | [Digital Accessibility in Maths: Making Things Add Up for Everyone](#JL-18-11-2026) |
| 02/12/2026 | [Simon Fairfax](https://www.liverpool.ac.uk/people/simon-fairfax) | University of Liverpool | [Student Community & Belonging](#SF-02-12-2026)|
| 10/02/2027 | [Joel Haddley](https://www.liverpool.ac.uk/people/joel-haddley) | University of Liverpool | [TBD](#JH-10-02-2027) |
...
### **21/10/2026** Contextualising the Curriculum through the History of Mathematics {#BS-21-10-2026}
:::{.columns}
:::{.column width=10%}
...
:::
:::{.column width=88%}
**Speaker**:  [Brigitte Stenhouse](https://profiles.open.ac.uk/brigitte-stenhouse) (The Open University)

:::{.callout-note title="Abstract" icon=false collapse=false}
Over the past three years, the Contextualising the Curriculum through the History of Mathematics project at The Open University has hosted four undergraduate student research interns.  During the internships, students engage with academic literature in history of mathematics in order to identify people, ideas, or artefacts that complement the undergraduate mathematics curriculum; the way in which their chosen histories “complement” the curriculum is left to the student, though they are encouraged to search for lesser-told stories that resonate with their personal interests.

In this talk I will walk through some of the ~15 articles soon to be available on the Contextualising the Curriculum VLE site, reflecting on what knowledge and study skills students can gain from engaging with these resources.
:::
:::
:::
...
### **18/11/2026** Digital Accessibility in Maths: Making Things Add Up for Everyone {#JL-18-11-2026}
:::{.columns}
:::{.column width=10%}
...
:::
:::{.column width=88%}
**Speaker**:  [Joshua Lim](https://www.bath.ac.uk/teams/centre-for-learning-teaching-clt/) (University of Bath)

:::{.callout-note title="Abstract" icon=false collapse=false}
When people think about accessibility in mathematics, the focus is often on making equations accessible to screen readers. While this is an essential part of making mathematical content accessible, students' experience of learning maths goes far beyond equations.  From lectures, visualisations and handwritten notes to recordings, assessments and digital resources, accessibility barriers can arise throughout the learning journey.  This seminar explores common barriers in mathematics education and highlights practical approaches that can make learning more flexible, effective and inclusive for everyone.
:::
:::
:::
...
### **02/12/2026** Student Community & Belonging {#SF-02-12-2026}
:::{.columns}
:::{.column width=10%}
![](images/Logos/Lpool-Logo.png){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
**Speaker**:  [Simon Fairfax](https://www.liverpool.ac.uk/people/simon-fairfax) (University of Liverpool)
...
:::
:::{.column width=88%}
**Speaker**:  [Joel Haddley](https://www.liverpool.ac.uk/people/joel-haddley) (University of Liverpool)
...
:::
:::{.column width=88%}
**Speaker**:  [Irene Biza](https://research-portal.uea.ac.uk/en/persons/irene-biza) (University of East Anglia)
...
:::
:::{.column width=88%}
**Speaker**:  [Robert Wilson](https://profiles.cardiff.ac.uk/staff/wilsonrh) (Cardiff University)
...
:::{.column width=88%}
**Speaker**:  [Ilaria Bussoli](https://researchportal.bath.ac.uk/en/persons/ilaria-bussoli/) (Univeristy of Bath)
...
:::
:::{.column width=88%}
**Speakers**:  [Thomas Cottrell](https://researchportal.bath.ac.uk/en/persons/thomas-cottrell/), [Tamsin Smith](https://researchportal.bath.ac.uk/en/persons/tamsin-smith/), [Ruth Wye](https://researchportal.bath.ac.uk/en/persons/ruth-wye/) & [Ameen Hassan](https://researchportal.bath.ac.uk/en/persons/ameen-hassan/) (University of Bath)

**Recording**:  [Link](https://teams.microsoft.com/l/meetingrecap?driveId=b%21AcvU60qEK0uyhI_SyqwRek6ue9ig81FOgtv2R8MJVQnS8NJ-H1TpRqZrRRZcHxAm&driveItemId=01VNQFUURDCWV6A4VY6RF22OMCMNHY6N25&sitePath=https%3A%2F%2Fcomputingservices-my.sharepoint.com%2F%3Av%3A%2Fg%2Fpersonal%2Ftls35_bath_ac_uk%2FIQAjFavgcrj0S605gmNPjzddAc4aYXOpXQGtq7x4Y6TpJG0&fileUrl=https%3A%2F%2Fcomputingservices-my.sharepoint.com%2Fpersonal%2Ftls35_bath_ac_uk%2FDocuments%2FRecordings%2FReengagement+tutorials+Seminar-20260304_131808-Meeting+Recording.mp4%3Fweb%3D1&iCalUid=040000008200E00074C5B7101A82E00800000000B75A115ED5ABDC010000000000000000100000008745CDF348BB9E4082A56843DAD538A3&threadId=19%3Ameeting_MTYwOWJhMTAtYmYyNi00ZjQxLTliYzUtZTNlZWY1NDgyMjZh%40thread.v2&organizerId=ecc800ca-2608-4db3-b8ee-813070b681cf&tenantId=377e3d22-4ea1-422d-b0ad-8fcc89406b9e&callId=05d64559-e7e5-4b0e-8989-1a8414bd097c&threadType=Meeting&meetingType=Scheduled&subType=RecapSharingLink_RecapCore)
...
### **18/03/2026** Interactivity in the Classroom
:::{.columns}
:::{.column width=10%}
![](images/Logos/Bath-Logo.png){width=100%}
:::
...
:::
:::{.column width=88%}
**Speaker**:  [Waleed A Ali](https://walben-ali.github.io/waleed-ali-webpage/) (University of Bath)

University of Bath

**Resources**: [Link](https://prime-bath.github.io/PRiME/resources/Interactivity2026.html)

:::{.callout-note title="Abstract" icon=false collapse=true}
Engagement and interactivity of university students within the classroom has been an issue in universities, even more so in recent years.  This talk will give an overview into some of the issues that might be causing this decline, from pedagogical, physical, psychological and environmental perspectives.  This talk will aim to share some ideas that the maths department has done to increase student engagement and interactivity as well as talking about some research into the area.
:::
:::
:::
...
:::
:::{.column width=88%}
**Speaker**:  [Paola Iannone](https://www.research.ed.ac.uk/en/persons/paola-iannone/) (University of Edinburgh)

**Recording**: [Link](https://bath-ac-uk.zoom.us/rec/share/VBZzVI982jhX3P7uptfP_VTEjncbDpgkxeo0E3-YIU4T6oFcZEQVwmDtlWyqAF0.zA6tUSPBhv9LrgOD?startTime=1774444733000
Passcode: Z5NzXq)

**Resources**:

:::{.callout-note title="Abstract" icon=false collapse=true}
Many institutions have courses in the first year of mathematics degrees which are called something like ‘introduction to proof’ courses and are aimed at easing the difficult transition of students to university mathematics. In this talk I will illustrate how such courses can be designed based on educational research findings. First I will very briefly review the relevant research on transition to university mathematics, difficulties with proof and assessment at the university level. From here I will show how this research has informed the design of the course ‘Introduction to University Mathematics’ at the University of Edinburgh while discussing the structure and assessment for this course.
:::
:::
:::
...
### **13/05/2026** Beyond the Mathematics of the Moment: Boundary Crossing Practices in Secondary Schools and in Higher Education
:::{.columns}
:::{.column width=10%}
![](images/Logos/UCL-Logo.jpg){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
**Speaker**:  [Evi Papadaki](https://profiles.ucl.ac.uk/104461-evi-papadaki) (University College London)

:::{.callout-note title="Abstract" icon=false collapse=true}
The seminar explores how boundary crossing – working productively across different practices or contexts – can serve as an opportunity for professional learning. In the first part, I will introduce key literature on boundary crossing and share examples from my own work. I will refer to my research into how secondary mathematics teachers create opportunities for classroom discussion beyond the 'mathematics of the moment' and connect lesson content to wider mathematical ideas. I will also draw from my work within collaborative cross‑disciplinary projects in Higher Education, where boundary crossing has been instrumental in designing resources for learning mathematics and statistics within other disciplinary contexts. The second part of the seminar will be interactive, encouraging participants to examine how these insights can inform their own teaching practices beyond the examples drawn from my work. Using scenario‑based activities, participants will work in small groups to identify existing boundary crossing opportunities in their own practice and develop new ones they might wish to incorporate. The session will conclude with a collective synthesis of potential directions for future research and innovation.
:::
:::
:::
...
:::
:::{.column width=88%}
**Speaker**:  [Adam Coates](https://researchportal.bath.ac.uk/en/persons/adam-coates) (University of Bath)
...
:::
:::{.column width=88%}
**Speaker**:  [Waleed Ali](https://researchportal.bath.ac.uk/en/persons/waleed-ali) (University of Bath)

**Recording**:  [Link](https://uniofbath.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=30d7c505-a2a2-4daa-a36b-b22e00dc2831)

**Resources**:  [Link](https://prime-bath.github.io/PRiME/resources/HEA2024.html)

:::{.callout-note title="Abstract" icon=false collapse=true}
This session will be open to everyone; staff, postgraduate students and anyone involved in teaching or teaching-based leadership roles. I will be giving an overview about applying for HEA Fellowships, especially after the release of the new specifications that will take effect in January 2025. The session will cover all the requirements for applying for the different HEA accreditations that the university provides (Associate Fellow, Fellow and Senior Fellow); following, there will be a Q&A session where I'll answer any questions you might have about the accreditation process.  Resources can be found [here](https://prime-bath.github.io/PRiME/resources/HEA2024.html).
:::
:::
:::
...
:::
:::{.column width=88%}
**Speaker**:  [Kat Phillips](https://katdoesmaths.me/) (University of Warwick)
...
:::
:::{.column width=88%}
**Speaker**:  [Cathy Smith](https://profiles.open.ac.uk/cathy-smith) (The Open University)
...
:::
:::{.column width=88%}
**Speaker**:  [Ben Walker](https://benjaminwalker.info/) (University of Bath)
...
:::
:::{.column width=88%}
**Speaker**:  [Ben Adams](https://people.bath.ac.uk/ba224/) (University of Bath)
...
:::
:::{.column width=88%}
**Speaker**:  [William Kay](https://willpkay.weebly.com/) (Cardiff University)
...
:::
:::{.column width=88%}
**Speaker**:  [Lara Alcock](https://laraalcock.com/) (University of Loughborough)

**Recording**:  [Link](https://uniofbath.cloud.panopto.eu/Panopto/Pages/Sessions/List.aspx#folderID=%22f4949889-15df-4faa-b7c8-b410008e204b%22)
...
:::
:::{.column width=88%}
**Speaker**:  [Evi Papadaki](https://papadakievi.github.io/) (University of Bath)
...
:::
:::{.column width=88%}
**Speaker**:  [Kevin Houston](https://www.kevinhouston.net/) (University of Leeds)
...
:::
:::{.column width=88%}
**Speaker**:  [Martyn Parker](https://warwick.ac.uk/fac/sci/statistics/staff/academic-research/parker/) (University of Warwick)
