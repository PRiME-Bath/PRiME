All seminars are held in **Wolfson Lecture Theatre 4W 1.7** on **Wednesdays 13:15-14:05**.  All the talks will be broadcasted live on the following [Zoom Link](https://bath-ac-uk.zoom.us/j/96861106151?pwd=wmYbhw8eSHSbV3t7Z2uiI8Dhvw4jGp.1).
...
:::{.columns}
:::{.column width=10%}
![](images/UCL-Logo.jpg){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
**Speaker**:  [Evi Papadaki](https://profiles.ucl.ac.uk/104461-evi-papadaki)
...
<!---
![](images/Watch-this-Space.jpg){width=50% fig-align="center"}
--->
...
:::{.columns}
:::{.column width=10%}
![](images/Cardiff-Logo.png){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
...
:::{.columns}
:::{.column width=10%}
![](images/Bath-Logo.png){width=100%}
:::
...
:::
:::{.column width=88%}
**Speaker**:  [Waleed A Ali](https://walben-ali.github.io/waleed-ali-webpage/)
...
:::{.columns}
:::{.column width=10%}
![](images/Edinburgh-Logo.png){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
**Speaker**:  [Paola Iannone](https://www.research.ed.ac.uk/en/persons/paola-iannone/)
...
:::{.columns}
:::{.column width=10%}
![](images/Warwick-Logo.png){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
...
:::{.columns}
:::{.column width=10%}
![](images/Loughborough-Logo.png){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
...
:::{.columns}
:::{.column width=10%}
![](images/Leeds-Logo.png){width=100%}
:::
:::{.column width=2%}
:::
:::{.column width=88%}
